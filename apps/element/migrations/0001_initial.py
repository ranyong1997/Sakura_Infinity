    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moduleid', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='project.module',
                                               verbose_name='关联模块')),
            ],
            options={
                'verbose_name': '测试用例',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Locat_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                 to='element.locationtype', verbose_name='定位类型')),
                ('caseid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='case_ste',
                                             to='element.case', verbose_name='关联用列')),
                ('operate', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                              to='element.operatetype', verbose_name='执行类型')),
            ],
            options={
                'verbose_name': '用列步骤',
