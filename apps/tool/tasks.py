...
# Celery -A Sakura_Infinity worker --loglevel=info --concurrency=10 异步任务
# celery -A celery_client worker --concurrency=10 --loglevel=info --logfile="/tmp/blackcat/blackcat.log" &


# Celery -A Sakura_Infinity  beat -l ERROR --scheduler django_celery_beat.schedulers:DatabaseScheduler 定时任务
