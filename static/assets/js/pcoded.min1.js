...
$(document).ready(function () {
    ...
    if ($('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $(".to-do-list input[type=checkbox]").on("click", function () {
        ...
        s(e)
    }), o <= 991 && ($(".main-search").addClass("open"), $(".main-search .form-control").css({width: "90px"})), $(".main-friend-cont").slimScroll({
        setTop: "1px",
        size: "5px",
        wheelStep: 10,
        touchScrollStep: 90,
    ...
    $(".card-option .close-card").on("click", function () {
        var e = $(this);
        e.parents(".card").addClass("anim-close-card"), e.parents(".card").animate({"margin-bottom": "0"}), setTimeout(function () {
        ...
        if (s.toggleClass("full-card"), $(this).children("a").children("span").toggle(), s.hasClass("full-card")) {
            ...
            var d = $(s, this), i = d.offset(), o = i.left, n = i.top, t = $(window).height(), c = $(window).width();
    ...
    var s = (this.attr("id"), {themelayout: "vertical", MenuTrigger: "click", SubMenuTrigger: "click"}),
        e = $.extend({}, s, e), d = {
            PcodedMenuInit: function () {
                ...
                var s = $(window), d = s.width();
                if (1 == $(".pcoded-navbar").hasClass("theme-horizontal")) if (d >= 768) {
                ...
                if (1 == $(".pcoded-navbar").hasClass("theme-horizontal")) {
                    ...
                    d >= 768 ? i.off("click").off("mouseenter mouseleave").hover(function () {
                        if ($(this).addClass("pcoded-trigger"), $(".pcoded-submenu", this).length) {
                            var e = $(".pcoded-submenu:first", this), s = e.offset(), d = s.left, i = e.width();
                            $(window).height();
                            if (d + i <= $(window).width()) $(this).removeClass("edge"); else {
                    ...
                    case"horizontal":
                        "hover" === e.SubMenuTrigger ? $("li.pcoded-hasmenu").on("mouseenter mouseleave", function (e) {
                            if ($(".pcoded-submenu", this).length) {
                                var s = $(".pcoded-submenu:first", this), d = s.offset(), i = d.left, o = s.width();
                                $(window).height();
...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://github.com/ranyong1997" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-rocket" aria-hidden="true"></i> My GitHub' +
    '</a> ' + '</div>' + '');
var $window = $(window);
